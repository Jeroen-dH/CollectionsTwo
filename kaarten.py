...
# schoppen ='A (Schoppen)',"Schoppen 2","Schoppen 3", "Schoppen 4", ' Schoppen 5', " Schoppen 6", " Schoppen 7", " Schoppen 8", "Schoppen 9 ", "Schoppen 10", "Schoppen Boer", "Schoppen vrouw", "Schoppen Koning"
# klaver = 'A (klaver)',"klaver 2","klaver 3", "klaver 4", ' klaver 5', " klaver 6", " klaver 7", " klaver 8", "klaver 9 ", "klaver 10", "klaver Boer", "klaver vrouw", "klaver Koning"
# ruiten = 'A (ruiten)',"ruiten 2","ruiten 3", "ruiten 4", ' ruiten 5', " ruiten 6", " ruiten 7", " ruiten 8", "ruiten 9 ", "ruiten 10", "ruiten Boer", "ruiten vrouw", "ruiten Koning"
# harten = 'A (Harten)',"Harten 2","Harten 3", "Harten 4", ' harten 5', " Harten 6", " Harten 7", " Harten 8", "Harten 9 ", "Harten 10", "Harten Boer", "Harten vrouw", "Harten Koning"
